...
using System.Linq;
using ServiceStack;
using DropdownTest.ServiceModel;

namespace DropdownTest.ServiceInterface;
...
public class TodosServices : Service
{
    ...
    public object Any(QueryTodosDropdown query)
    {
        return new UrlAdapterResponse<Todo>(Todos.GetAll());
    }
