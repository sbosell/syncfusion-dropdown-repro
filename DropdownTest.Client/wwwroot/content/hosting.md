...
##  [/DropdownTest.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/DropdownTest.Client)
...
## [/DropdownTest](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/DropdownTest)

The .NET 6 `/DropdownTest` backend server is required for this App's dynamic functions including the Hello API on the home page
